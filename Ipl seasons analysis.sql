...
/*What is the total number of runs scored by each player in the  IPL  */
SELECT 
...
/*total run scored by bastsman team in 2021 seaseons*/
SELECT 
    match_summery.year,
    players.team,
    batting_summary.batsmanName,
...
/*q2 What is the total number of wickets taken by each player*/
SELECT 
...
/* bower name with taken total wicketes Who are the top 5 wicket-takers in the 2021 seasons */
SELECT 
    bowling_summary.bowlerName,
    match_summery.year,
    SUM(bowling_summary.wickets) AS total_wickets
